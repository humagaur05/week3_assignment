...
public class ConsultationController {
    ...
    public List<TestRequest> getForConsultations()  {
        ...
        //return the result of the above method call as the response
    ...
    public List<TestRequest> getForDoctor()  {
        // Create an object of User class and store the current logged in user first. This is the current doctor
    ...
    public TestRequest updateConsultation(@PathVariable Long id,@RequestBody CreateConsultationRequest createConsultationRequest) {
        ...
        //to update the current test request id with the consultation details by the current user(object created)
